...
function finish(attachment){
    ...
    attachment.html = `${process.env.rootPath}/uploads/cache/${attachment.originalname}`;               // Send new cached file
...
process.on('message', attachment => {
    ...
    attachment.originalurl = `${process.env.rootPath}/uploads/${attachment.originalname}`; // Send original
