<template>
  <header :style="{'background-image': `url('http://localhost:2087/banner/${channel.member_list[0].uuid}')`}">
    <div class="headerDetails">
      <div class="headerLeft">
        <div class="channelInfo">
          <router-link  v-if="channel. type == 'private'" :to="`/profile/${channel.member_list[0].username}`"><img class="channelPfp" :src="`http://localhost:2087/pfp/${channel.member_list[0].uuid}`" alt=""></router-link>
          <a v-if="channel.type == 'group'"><img class="channelPfp" :src="`http://localhost:2087/pfp/_default`" alt=""></a>
          <div class="info">
      ...
      <div class="headerRight">
        ...
        <div class="meInfo">
          <router-link :to="`/profile/${me.username}`"><img class="channelPfp" :src="`http://localhost:2087/pfp/${me.uuid}`" alt=""></router-link>
        </div>
      </div>
    </div>
