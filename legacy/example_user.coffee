{
    ...
    profile: {   
        ...
        pfp: "http://localhost:2087/uplo...png",                                     # Customizable profile pic
        banner: "http://localhost:2087/uplo....gif",                                 # Customizable profile banner
    ...
    settings: {
        ...
        sounds: {
            typing: { 
                ...
                url: "http://localhost:2087/uploads/VR_drum_hat_trappy.wav" },       # Sound URL
            mention: { 
                enabled: true,                                                      # If its enabled
                url: "http://localhost:2087/uploads/id.mp3" },                       # Sound URL
        },
        notifications: {
