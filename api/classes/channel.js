...
function Channel(author, participants, lastMessage, king) {
    ...
    if (lastMessage) this.lastMessage = lastMessage     // The UUID of the latest message sent in that channel if any
