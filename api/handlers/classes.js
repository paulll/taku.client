...
for (const file of classFiles) {
  ...
  if (Object.keys(loadedFile).length != 0) console.log(`[HANDLER]`.bgMagenta.black + ` loaded class ` + `[${file}]`.magenta + ` successfully!`);
  else console.log(`[HANDLER]`.bgRed.black + ` class ` + `[${file}]`.red + ` failed!`.red);
} 
