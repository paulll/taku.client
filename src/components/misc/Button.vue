<template>
  <button
    ...
    class="bg-dark-300 whitespace-nowrap select-none min-w-max rounded-8px flex font-medium p-1 items-center justify-center transition-all duration-100 border-3 active:bg-white-400 active:border-white-500"
  >
